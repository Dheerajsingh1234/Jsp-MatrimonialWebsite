...
<div class="col-md-9 search_left">
  <form method=post action="search1.jsp" >	
   <div class="form_but1">
	...
	<div class="col-sm-7 form_radios">
		<input type="radio" class="radio_1"  value="male" name ="sex"/> Male &nbsp;&nbsp;
		<input type="radio" class="radio_1" checked="checked" value="female" name="sex" /> Female
  ...
  <div class="form_but1">
	...
	<div class="col-sm-7 form_radios">
        ...
        <input class="form-control has-dark-background"  name="cast" id="slider-name" placeholder="general" type="text" required="">
      </div>
    </div>  
      <div class="clearfix"> </div>
	</div>
