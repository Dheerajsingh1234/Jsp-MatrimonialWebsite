<%-- 
    Document   : edit1.jsp
    Created on : Aug 22, 2019, 4:04:09 PM
    Author     : dell
--%>
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><input type="text" value=<%= rs.getString(1)%> name="name"></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Cast :</td>
							<td class="day_value"><input type="text" value=<%= rs.getString(6)%> name="cast"></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Religion :</td>
							<td class="day_value"><input type="text" value=<%= rs.getString(7)%> name="religion"></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Marital Status :</td>
							<td class="day_value"><input type="text" value=<%= rs.getString(9)%> name="marital"></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Location :</td>
							<td class="day_value"><input type="text" value=<%= rs.getString(10)%> name="location"></td>
						</tr>
                                                <tr class="opened">
							<td class="day_label">Hieght :</td>
							<td class="day_value"><input type="text" value=<%= rs.getString(8)%> name="hieght"></td>
						</tr>
                                                <tr class="opened">
							<td class="day_label">Gender :</td>
							<td class="day_value"><input type="text" value=<%= rs.getString(4)%> name="Gender"></td>
						</tr>
					    <tr class="closed">
							<td class="day_label">DOB :</td>
							<td class="day_value closed"><span><input type="text" value=<%= rs.getString(5)%> name="dob"></span></td>
						</tr>
					    <tr class="closed">
							<td class="day_label">Education :</td>
							<td class="day_value closed"><span><input type="text" value=<%= rs.getString(11)%> name="education"></span></td>
						</tr>
                                                 <tr class="closed">
							<td class="day_label">Country :</td>
							<td class="day_value closed"><span><input type="text" value=<%= rs.getString(12)%> name="country"></span></td>
						</tr>
                                                 <tr class="closed">
							<td class="day_label">State :</td>
							<td class="day_value closed"><span><input type="text" value=<%= rs.getString(13)%> name="State"></span></td>
						</tr>
                                                 <tr class="closed">
							<td class="day_label">Age :</td>
							<td class="day_value closed"><span><input type="text" value=<%= rs.getString(14)%> name="age"></span></td>
						</tr>
                                                <tr class="closed">
						
							<td class="day_value closed" ="col-sm-8><span><input type="submit" value="Update" ></span></td>
						</tr>
				    </tbody>
				</table>
                             </form>                   
				<ul class="login_details">
			      <li>Already a member? <a href="login.jsp">Login Now</a></li>
			      <li>If not a member? <a href="register.jsp">Register Now</a></li>
			    </ul>
			</div>
			<div class="clearfix"> </div>
		</div>
