...
<%@page import ="java.sql.*,java.util.*,javax.swing.*,java.awt.*"%>
<%
          String email=null;
          String code=null;
 ...
 if(email!=null && session.getAttribute(email)!=null)
        {
          ...
          try
            { 
                ...
                ResultSet rs = st.executeQuery("select * from webstudent where code='"+code+"'");
			...
			<div class="col-sm-8 row_1">
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><%= rs.getString(1)%></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="opened">
							...
							<td class="day_value"><%= rs.getString(7)%></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="closed">
							...
							<td class="day_value closed"><span><%= rs.getString(5)%></span></td>
						</tr>
					    <tr class="closed">
							<td class="day_label">Education :</td>
							<td class="day_value closed"><span><%= rs.getString(11)%></span></td>
						</tr>
                                              <tr class="closed">
							<td class="day_label">Country :</td>
							<td class="day_value closed"><span><%= rs.getString(12)%></span></td>
						</tr> 
                                                <tr class="closed">
							<td class="day_label">State :</td>
							<td class="day_value closed"><span><%= rs.getString(13)%></span></td>
						</tr> 
                                                <tr class="closed">
							<td class="day_label">Age :</td>
							<td class="day_value closed"><span><%= rs.getString(14)%></span></td>
						</tr> 
						    </tbody>
				</table>
				<ul class="login_details">
			      ...
			      <li>If not a member? <a href="register.jsp">Register Now</a></li>
                    ...
                    <form method=post action="msg.jsp?id=<%=rs.getString(16)%>">                                
		   <div class="buttons">
			   <div class="vertical">Send Mail</div>
                         <div class="form-actions">
                             <input type="text" name="msg" placeholder="type message" class="btn_1 ">
			    <input type="submit"  value = "Send" class="btn_1 submit">
			  </div>
                          </div>
		</form>	
...
<%
                ...
                else
                {
                    ...
                    response.sendRedirect("index.jsp?invalid_code");
