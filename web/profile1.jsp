...
<!-- FlexSlider -->
 ...
 <form method=post action ="update.jsp">
       ...
       Cast:<input type="text" name="fname" value="<%=rs.getString(6)%>"required><br>
       Religion :<input type="text" name="contact" value="<%=rs.getString(7)%>"required><br>
         Marital Status:<input type="text" name="gender" value="<%=rs.getString(9)%>"required><br>
          Location<input type="text" name="country" value="<%=rs.getString("10")%>"required><br>
          DOB<input type="text" name="email" value="<%=rs.getString("5")%>"required><br>
          Education<input type="text" name="email" value="<%=rs.getString("11")%>"required><br>
