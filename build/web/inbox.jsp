                        ...
                        <%
                          ...
                          try
                            { 
                             ...
                             //   ResultSet rs1= st1.executeQuery("select * from webstudent where Email='"+email+"'");
                                ResultSet rs = st.executeQuery("select * from inbox where Temail='"+email+"'");
                                while(rs.next())
                                {
                                    Statement st1 = cn.createStatement();
                                   
                                    ResultSet rs1= st1.executeQuery("select * from webstudent where Email='"+rs.getString(4)+"'");
                                    if(rs1.next())
                                  {  
                                        
                            %>        
                                            
                                                <div class="thumb"><a href="viewprofile.jsp"><img src="images/p13.jpg" class="img-responsive" alt=""/></a></div>
                                                    <div class="jobs_right">
                                                                <h6 class="title"><a href="view_profile.jsp"><%=rs1.getString(1)%></a></h6>
							<ul class="top-btns">
