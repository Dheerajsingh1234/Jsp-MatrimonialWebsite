...
<div class="grid_3">
  ...
  <div class="col-md-9 profile_left1">
    ...
    <div class="profile_top"><a href="viewprofile.jsp">
      <h2>254879</h2>
	    ...
	    <div class="col-sm-3">
	     ...
	     <%
                                    ...
                                    <tbody>
                                            <tr class="opened_1">
                                                ...
                                                <tr class="opened">
                                                            ...
                                                            <td class="day_value"><%= rs.getString(14)%></td>
                                                    </tr>
                                                <tr class="opened">
               ...
               <form method=post action="viewprofile.jsp?id=<%=rs.getString(16)%>">                                
		   <div class="buttons">
			   <div class="vertical">Send Mail</div>
                         <div class="form-actions">
			    <input type="submit"  value = "view profile" class="btn_1 submit">
			  </div>
                          </div>
		</form>	  
